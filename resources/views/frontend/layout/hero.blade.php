...
<section class="w-full relative select-none px-3 sm:px-5 md:px-6 lg:px-10 pt-0">
    @if($slides->count() > 0)
        <div x-data="{
            ...
            class="relative w-full h-[160px] xs:h-[180px] sm:h-[240px] md:h-[340px] lg:h-[380px] xl:h-[460px] rounded-lg sm:rounded-xl lg:rounded-2xl overflow-hidden shadow-xl shadow-black/20">
