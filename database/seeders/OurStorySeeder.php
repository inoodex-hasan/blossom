...
class OurStorySeeder extends Seeder
{
    ...
    {
        // Ensure storage directory exists and copy asset file for Filament FileUpload preview
        $storageDir = storage_path('app/public/stories');
        if (! File::exists($storageDir)) {
            File::makeDirectory($storageDir, 0755, true);
        }

        $sourceFile = public_path('assets/images/cta.jpeg');
        $destFile = $storageDir . DIRECTORY_SEPARATOR . 'cta.jpeg';
